...
export default function AdminLogin() {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(false)
    if (err) {
      setError('Email atau password salah nih, coba lagi.')
      return
    }
    navigate('/')
  }
    ...
    return (
      <div className="container login-wrap">
        <div className="panel" style={{ textAlign: 'center' }}>
          <p style={{ marginBottom: 16, fontWeight: 700 }}>Kamu sudah login sebagai admin 🎉</p>
  ...
  return (
    <div className="container login-wrap">
      ...
      <h1 className="page-title" style={{ fontSize: 'clamp(28px, 6vw, 36px)' }}>
        Masuk Yuk
      </h1>
      <p className="subtitle">Khusus buat kamu — buat kelola dan rapiin kenangan kelompok.</p>
